...
/**
 ...
 The file extension for templates using this engine is `stencil`. If the file extension of the template specified in the call to [`response.render`](https://kitura-next.github.io/Kitura/Classes/RouterResponse.html#/s:6Kitura14RouterResponseC6renderACSS_s10DictionaryVySSypG7context0A14TemplateEngine16RenderingOptions_p7optionstKF) matches, this template engine will be invoked. If no extension is specified, _and_ this engine has been set as the default via [`router.setDefault(templateEngine:)`](https://kitura-next.github.io/Kitura/Classes/Router.html#/s:6Kitura6RouterC10setDefaulty0A14TemplateEngine0eF0_pSg08templateF0_tF), the extension will be applied automatically.
...
public class StencilTemplateEngine: TemplateEngine {
    ...
    /// or you can customize this by setting the [`router.viewsPath`](https://kitura-next.github.io/Kitura/Classes/Router.html#/s:6Kitura6RouterC9viewsPathSSvp) property.
    ///
    ...
    /// Note that this function is called by Kitura when you call [`response.render(_:context:options:)`](https://kitura-next.github.io/Kitura/Classes/RouterResponse.html#/s:6Kitura14RouterResponseC6renderACSS_s10DictionaryVySSypG7context0A14TemplateEngine16RenderingOptions_p7optionstKF).
    ///
    ...
    /// Note that this function is called by Kitura when you call [`response.render(_:with:forKey:options:)`](https://kitura-next.github.io/Kitura/Classes/RouterResponse.html#/s:6Kitura14RouterResponseC6renderACSS_x4withSSSg6forKey0A14TemplateEngine16RenderingOptions_p7optionstKs9EncodableRzlF).
    ///
    /// - Parameter filePath: The path of the template file to use when generating
    ///                      the content.
